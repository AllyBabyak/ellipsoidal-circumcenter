# -*- coding: utf-8 -*-
"""
Created on Tue Feb 28 15:42:37 2023

@author: a.babyak
"""

from math import atan, tan, sin, cos, sqrt, atan2, asin, radians, degrees
import random
...
EC = (45.2501566,-75.8002569)
EC = CoordToRadians(EC)

Azimuth = random.uniform(0,6)

Point = VincentyForward(EC, Azimuth, 100000)
Point = CoordToDegrees(Point)
